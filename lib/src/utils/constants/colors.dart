...
class ZipZapColors {
  ...
  static const Color primaryBackgroud = Color(0xFF3F5FF);

  // background container colors
  static const Color lightContainer = Color(0xFFF6F6F6);
  static Color darkContainer = ZipZapColors.white.withOpacity(0.1);

  // button colors
  static const Color buttonPrimary = Color(0xFF4b68ff);
  static const Color primarySecondry = Color(0xFF6c7570);
